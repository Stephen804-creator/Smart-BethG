 ...
 *
 * V1 PRODUCTION FRONTEND DESIGN SYSTEM
 *
 * Responsibilities:
 * - Application shell
 * - Navigation
...
:root {
    ...
    --surface-hover: #192943;
    --surface-active: #1d3150;
...
.hero h1 {
    ...
    font-size: clamp(28px, 3vw, var(--text-3xl));
